...
async function postRestore(request: NextRequest): Promise<Response> {
  // v1.37.0 — MANAGE. The undo beside a delete the level admits; the `where` only ever
  // clears a tombstone the record already carried.
