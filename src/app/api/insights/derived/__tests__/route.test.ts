...
// `requireAuth()` (in addition to the existing per-metric sleep/recovery
// gate). Mock it default-enabled so the existing assertions ride through;
// the off → 403 coverage lives in the route-gate inventory test.
