...
export const measurementSourceEnum = z.enum([
  ...
  // exactly like WHOOP/FITBIT. Part of this enum so the read/response shapes
  // (and the iOS decoder) can decode the rows it surfaces; deliberately absent
